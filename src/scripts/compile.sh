...
echo "unit cube"
./Main.native --src aec/cads-to-compile/unit.cad3 --tgt aec/compiled-meshes/mesh3/unit.mesh3
./Main.native --src aec/compiled-meshes/mesh3/unit.mesh3 --tgt aec/compiled-meshes/stl/unit.stl
printf "${PASS}\n\n"

echo "hexagonal prism"
./Main.native --src aec/cads-to-compile/hexagon.cad3 --tgt aec/compiled-meshes/mesh3/hexagon.mesh3
...
./Main.native --src aec/cads-to-compile/affine1.cad3 --tgt aec/compiled-meshes/mesh3/affine1.mesh3
...
./Main.native --src aec/cads-to-compile/affine2.cad3 --tgt aec/compiled-meshes/mesh3/affine2.mesh3
./Main.native --src aec/compiled-meshes/mesh3/affine2.mesh3 --tgt aec/compiled-meshes/stl/affine2.stl
printf "${PASS}\n\n"

echo "combining binops"
./Main.native --src aec/cads-to-compile/cube-2hole.cad3 --tgt aec/compiled-meshes/mesh3/cube-2hole.mesh3
